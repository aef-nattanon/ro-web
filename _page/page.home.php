<div class="contener-dino">
    <div class="dino"><img width="45%" src="assets/images/logo2.png"></div>
</div>
<section class="home-menu pb-0" style="padding: 30% 0;">
        ...
        <div class="container" style="background-color: #fff; margin-top: 20px;">
            <div class="row">
                <div class="col-8" style="margin-top: 15px;">
                        ...
                        <div class="card" style="padding: 10px; border-radius: 9px;">
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <?php
                                    $res['news'] = $connect->query("SELECT * FROM `web_news`  WHERE color='highlight' ORDER BY `id` DESC LIMIT 10;");
                    ...
                    <div class="card" style="margin-top: 15px; padding: 10px; background: rgba(0, 87, 0, 1); border-radius: 9px;">
                        <div class="card" style="padding: 10px; border-radius: 9px;">
                            <img class="d-block w-100 hvr-bubble-float-left" style="margin-top: -45px;" src="assets/upload/promotion.png" alt="Second slide">

                            <div class="container">
                                <div class="row">

                                    <?php
                                    $res['news'] = $connect->query("SELECT * FROM `web_news` WHERE color='promotion' ORDER BY `id` DESC LIMIT 10;");
                                    while ($info['news'] = $res['news']->fetch_assoc()) {
                                    ?>
                ...
                <div class="col-4" style="margin-top: 15px;">
                    <div>
                        ...
                        <a href="#" data-toggle="modal" data-target="#model-register"><img class="d-block w-100 hvr-bubble-float-left" src="assets/upload/menu/menu-2.png" alt="Second slide"></a>
                                ...
                                <table style="color: #ffcc00;background-color: #000;border-style: solid;border-color: #ffcc00;width: 100%;" class="table">
                                    <thead>
                                        <tr align="center">
                                            ...
                                            <th><i class="fas fa-signal"></i> Lv</th>
                                        </tr>
                                    </thead>
                                    <tbody>

                                        <?php
                                        $res['rank'] = $connect->query("SELECT * FROM `char` ORDER BY `base_level` DESC LIMIT 10;");
                                        $iiii = 1;
                                        ...
                                        ?>
                                            <tr align="center">
                                                ...
                                                <td><?php echo $info['rank']['base_level']; ?></td>
                                            </tr>
                                        <?php
                                        }
                                        ?>
                    ...
                    <div class="card" style="padding: 10px; margin-top: 10px; background: rgba(0, 87, 0, 1); border-radius: 9px;">
                        <div class="card" style="padding: 10px; border-radius: 9px;">
                            <img class="d-block w-100 hvr-bubble-float-left" style="margin-top: -45px;" src="assets/upload/guild-ranking.png" alt="Second slide">
                            ...
                            <div class="table-responsive">
                                <table style="color: #ffcc00;background-color: #000;border-style: solid;border-color: #ffcc00;width: 100%;" class="table">
                                    <thead>
                                        <tr align="center">
                                            <th><i class="fa fa-trophy"></i> อันดับ</th>
                                            <th><i class="fas fa-hand-point-right"></i> ชื่อ</th>
                                            <th><i class="fas fa-signal"></i> Lv</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <?php
                                        $res['rank'] = $connect->query("SELECT * FROM `guild` ORDER BY `guild_lv` DESC LIMIT 10;");
                                        $iiii = 1;
                                        while ($info['rank'] = $res['rank']->fetch_assoc()) {
                                        ...
                                        ?>
                                            <tr align="center">
                                                <td><?php echo $iiii++; ?></span></td>
                                                <td><?php echo $info['rank']['name']; ?></td>
                                                <td><?php echo $info['rank']['guild_lv']; ?></td>
                                            </tr>
                                        <?php
                                        }
                                        ?>
                                ...
                                <table style="color: #ffcc00;background-color: #000;border-style: solid;border-color: #ffcc00;width: 100%;" class="table">
                                    <thead>
                                        <tr align="center">
                                            <th><i class="fa fa-trophy"></i> อันดับ</th>
                                            <th><i class="fas fa-hand-point-right"></i> รายชื่อ</th>
                                            <th><i class="fas fa-signal"></i> Kill</th>
                                        </tr>
                                    </thead>
                                    <tbody>

                                        <?php
                                        $res['rank'] = $connect->query("SELECT * FROM woe_ranking WHERE Kills > 0 ORDER BY Kills DESC LIMIT 10;");
                                        $iiii = 1;
                                        while ($info['rank'] = $res['rank']->fetch_assoc()) {
                                        ...
                                        ?>
                                            <tr align="center">
                                                <td><?php echo $iiii++; ?></span></td>
                                                <td><?php echo $info['rank']['PlayerName']; ?></td>
                                                <td><?php echo $info['rank']['Kills']; ?></td>
                                            </tr>
                                        <?php
                                        }
                                        ?>
