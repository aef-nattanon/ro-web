            ...
            <div class="row">
                ...
                <div class="col-md-12 ml-auto" style="margin-bottom: 10px; padding: 50px;">
                    <div class="card" style="padding: 10px; border-radius: 9px;">
                        <div class="text-left mt-1"><i class="fa fa-angle-right"></i> ชื่อผู้ใช้ <span class="description"><i class="fa fa-info-circle"></i> ต้องเป็น A-Z a-z 0-9 และมีตัวอักษรอย่างน้อย 6 เเต่ไม่เกิน 25 ตัว</span></div>
                        ...
                        <div class="text-left mt-1"><i class="fa fa-angle-right"></i> รหัสผ่าน <span class="description"><i class="fa fa-info-circle"></i> มีตัวอักษรอย่างน้อย 6 เเต่ไม่เกิน 25 ตัว</span></div>
